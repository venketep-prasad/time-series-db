...
public class MaxStageTests extends AbstractWireSerializingTestCase<MaxStage> {
    ...
    private void testSerializationRoundtripForConfiguration(List<String> groupByLabels) throws IOException {
        // Arrange
        MaxStage originalStage = groupByLabels.isEmpty() ? new MaxStage() : new MaxStage(groupByLabels);
        ...
        try (BytesStreamOutput out = new BytesStreamOutput()) {
            ...
            // Read it back
            try (StreamInput in = out.bytes().streamInput()) {
                MaxStage deserializedStage = MaxStage.readFrom(in);
    ...
    public void testSerializationStreamPosition() throws IOException {
        ...
        MaxStage stage1 = new MaxStage("service1");
        MaxStage stage2 = new MaxStage(List.of("service2", "region"));
        ...
        try (BytesStreamOutput out = new BytesStreamOutput()) {
            ...
            try (StreamInput in = out.bytes().streamInput()) {
                MaxStage readStage1 = MaxStage.readFrom(in);
                MaxStage readStage2 = MaxStage.readFrom(in);
    ...
    public void testSerializationEmptyStream() throws IOException {
        ...
        try (BytesStreamOutput out = new BytesStreamOutput(); StreamInput in = out.bytes().streamInput()) {
            expectThrows(Exception.class, () -> MaxStage.readFrom(in));
        }
    }

    public void testSerializationDataIntegrity() throws IOException {
        // Test that serialized data maintains integrity
        MaxStage originalStage = new MaxStage(List.of("service", "region", "environment"));
        ...
        try (BytesStreamOutput out = new BytesStreamOutput()) {
            ...
            try (StreamInput in = out.bytes().streamInput()) {
                ...
                assertEquals("Exact name should be maintained", "max", readStage.getName());
    ...
    public void testSerializationBehaviorValidation() throws IOException {
        ...
        MaxStage originalStage = new MaxStage("test-service");
